...
//   private row: ActionRowBuilder<ButtonBuilder> | null;
...
//   constructor(player: any, name: string, message: Message) {
//     this.player = player;
...
//     await this[this.name as keyof this]();
...
//         this.yesNoButton = new ActionRowBuilder<ButtonBuilder>().addComponents(
//           new ButtonBuilder().setStyle(1).setLabel("Yes").setCustomId("start"),
//           new ButtonBuilder().setStyle(1).setLabel("No").setCustomId("cancel")
//         );
