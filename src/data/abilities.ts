interface Ability {
  ...
  name: string;
  cooldown: number;
  execute: (user: string, target?: string | string[]) => void;
}
...
const abilities: { [key: string]: Ability } = {
  ...
  Bloodlust: {
    ...
    execute: (user) => {
      console.log(
        `${user} enters a state of frenzy. Their attack speed and damage increase.`
      );
  ...
  "Raging Strike": {
    ...
    execute: (user, target) => {
      console.log(
        `${user} unleashes a wild Raging Strike on ${target}. It deals massive damage!`
      );
  ...
  "Arena Spin": {
    ...
    execute: (user, targets) => {
      console.log(
        `${user} performs an Arena Spin, hitting multiple opponents.`
      );
  ...
  "Precision Strike": {
    ...
    execute: (user, target) => {
      console.log(
        `${user} executes a precise Precision Strike on ${target}. It's a critical hit!`
      );
  ...
  "Honor's Resolve": {
    ...
    execute: (user) => {
      console.log(
        `${user} enters Honor's Resolve, gaining increased resistance to status effects.`
      );
  ...
  Fireball: {
    ...
    execute: (user, target) => {
      console.log(
        `${user} hurls a Fireball at ${target}. ${target} takes damage over time.`
      );
  ...
  Thunderstorm: {
    ...
    execute: (user, targets) => {
      console.log(
        `${user} calls forth a Thunderstorm, damaging multiple opponents.`
      );
  ...
  "Drain Life": {
    ...
    execute: (user, target) => {
      console.log(
        `${user} drains the life force from ${target}. ${user} is healed.`
      );
  ...
  "Mirror Image": {
    ...
    execute: (user) => {
      console.log(
        `${user} creates multiple illusory copies to confuse opponents.`
      );
  ...
  "Mind Trick": {
    ...
    execute: (user, target) => {
      console.log(
        `${user} uses a Mind Trick on ${target}. ${target} is disoriented.`
      );
  ...
  "Shadow Step": {
    ...
    execute: (user, target) => {
      console.log(
        `${user} teleports behind ${target}, gaining a positional advantage.`
      );
  ...
  "Dual Wield": {
    ...
    execute: (user) => {
      console.log(
        `${user} wields two weapons simultaneously, increasing attack speed.`
      );
  ...
  Evasion: {
    ...
    execute: (user) => {
      console.log(
        `${user} evades incoming attacks, reducing damage taken for a short period.`
      );
  ...
  "Shuriken Barrage": {
    ...
    execute: (user, targets) => {
      console.log(
        `${user} throws a flurry of shurikens, hitting multiple targets.`
      );
  ...
  "Charming Presence": {
    ...
    execute: (user, target) => {
      console.log(
        `${user} uses Charming Presence. ${target} is charmed and becomes passive.`
      );
  ...
  "Acrobatic Flourish": {
    ...
    execute: (user) => {
      console.log(
        `${user} performs an Acrobatic Flourish, increasing evasion.`
      );
  ...
  "Healing Light": {
    ...
    execute: (user, target) => {
      console.log(
        `${user} uses Healing Light on ${target}. ${target} is healed.`
      );
      // Implement healing logic here
    },
  },
  "Divine Protection": {
    ...
    execute: (user) => {
      console.log(
        `${user} provides a shield of Divine Protection, absorbing incoming damage.`
      );
      // Implement shield logic here
    },
  },
